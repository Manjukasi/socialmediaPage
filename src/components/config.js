export const FETCH_URL = "https://panorbit.in/api/users.json";
export const Img_url = "https://panorbit.in/wp-content/uploads/2019/hotlink-ok/100" //Constants should be all caps
